...
#SBATCH --output=/groups/pupko/yairshimony/secretion_signal_prediction/outputs_optimization/embeddings_classifiers/pt5_layers_expirement/%A_%a.out
#SBATCH --error=/groups/pupko/yairshimony/secretion_signal_prediction/outputs_optimization/embeddings_classifiers/pt5_layers_expirement/%A_%a.err

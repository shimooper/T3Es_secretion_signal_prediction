...
EMBEDDINGS_DIR = os.path.join(PROJECT_BASE_DIR, 'outputs')
...
EMBEDDINGS_POSITIVE_TRAIN_DIR = os.path.join(EMBEDDINGS_DIR, "train_positive")
EMBEDDINGS_NEGATIVE_TRAIN_DIR = os.path.join(EMBEDDINGS_DIR, "train_negative")

EMBEDDINGS_POSITIVE_TEST_DIR = os.path.join(EMBEDDINGS_DIR, "test_positive")
EMBEDDINGS_NEGATIVE_TEST_DIR = os.path.join(EMBEDDINGS_DIR, "test_negative")

EMBEDDINGS_POSITIVE_XANTOMONAS_DIR = os.path.join(EMBEDDINGS_DIR, "xantomonas_positive")
EMBEDDINGS_NEGATIVE_XANTOMONAS_DIR = os.path.join(EMBEDDINGS_DIR, "xantomonas_negative")

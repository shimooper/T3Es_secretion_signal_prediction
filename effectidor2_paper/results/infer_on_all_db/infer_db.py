...
DB_PATH = PROJECT_ROOT_DIR / 'common' / 'data' / 'raw_data' / 'T3Es10_EDITED_NO_PARTIAL_v2.faa'
INFERENCE_SCRIPT_PATH = PAPER_DIR / 'src' / 'inference' / 'predict_secretion_signal.py'

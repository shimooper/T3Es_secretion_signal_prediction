...
#SBATCH --output=/groups/pupko/yairshimony/secretion_signal_prediction/effectidor2_paper/src/classic_ml_classifiers/%j.out        # Standard output and error log (%j expands to jobId)
#SBATCH --error=/groups/pupko/yairshimony/secretion_signal_prediction/effectidor2_paper/src/classic_ml_classifiers/%j.err         # Separate file for standard error

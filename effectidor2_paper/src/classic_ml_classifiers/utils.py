...
def prepare_Xs_and_Ys(logger, model_id, split, always_calc_embeddings, hidden_layer_number=None):
    if model_id == 'protein_bert':
        ...
        from effectidor2_paper.src.pretrained_embeddings.calc_pt5_embeddings import calc_pt5_embeddings
        ...
        from effectidor2_paper.src.pretrained_embeddings.calc_esm_embeddings import calc_esm_embeddings

...
POSITIVE_TRAIN_FILE=$(python -c "from consts import POSITIVE_TRAIN_FILE; print(POSITIVE_TRAIN_FILE)")
...
POSITIVE_TEST_FILE=$(python -c "from consts import POSITIVE_TEST_FILE; print(POSITIVE_TEST_FILE)")
...
POSITIVE_XANTOMONAS_FILE=$(python -c "from consts import POSITIVE_XANTOMONAS_FILE; print(POSITIVE_XANTOMONAS_FILE)")
...
NEGATIVE_TRAIN_FILE=$(python -c "from consts import NEGATIVE_TRAIN_FILE; print(NEGATIVE_TRAIN_FILE)")
...
NEGATIVE_TEST_FILE=$(python -c "from consts import NEGATIVE_TEST_FILE; print(NEGATIVE_TEST_FILE)")
...
NEGATIVE_XANTOMONAS_FILE=$(python -c "from consts import NEGATIVE_XANTOMONAS_FILE; print(NEGATIVE_XANTOMONAS_FILE)")
